...
public class AirportController {
    ...
    @Operation(summary = "Get a record by its IATA code", description = "Returns an airport record searching by its unique three character IATA code")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all airports", description = "Returns a list with all registered airports")
    @ApiResponses(value = {
