...
public class AirplaneTypeController {
    ...
    @Operation(summary = "Get an airplane type by id",
            description = "Returns an airplane type record using its unique identifier.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all airplane types",
            description = "Returns a list with all registered airplane types with optional arguments to filter.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Create a new airplane type",
            description = "Creates a new airplane type record and returns its data.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update an airplane type seat quantities",
            description = "Finds an airplane type record by its id and allows update its seats quantity.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update an airplane type identity",
            description = "Finds an airplane type record by its id and allows update its producer and model names.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Airplane type updated successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ResponseAirplaneTypeDto.class))),
            @ApiResponse(responseCode = "400", description = "Error by invalid arguments",
    ...
    @Operation(summary = "Deactivate an airplane type",
            description = "Finds an airplane type record by its id and changes its status to INACTIVE.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Activate an airplane type",
            description = "Finds an airplane type record by its id and changes its status to ACTIVE.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Retire an airplane type",
            description = "Finds an airplane type record by its id and changes its status to RETIRED.")
    @ApiResponses(value = {
